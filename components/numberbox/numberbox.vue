<template>
	<view class="tui-numberbox-class tui-numberbox">
		...
		<input type="number" v-model="val" :max='max' :min='min' :maxlength="maxlength" :disabled="disabled" @blur="blur" class="tui-num-input" :style="{color:color,fontSize:px(iconsize),background:bgcolor,height:px(height),width:px(width)}" />
