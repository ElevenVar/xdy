				...
				switch(mode){
					case "limit":
						...
						if(col1.value!=checkArr[0].value){
							let hours=initPicker.initLimitHours(_this.startHour,_this.endHour,_this.minuteStep,_this.afterStep,col1.value);
							let minutes=initPicker.initLimitMinutes(_this.startHour,_this.endHour,_this.minuteStep,_this.afterStep,col1.value,col2.value);
			...
			initData(){
				...
				switch(mode){
					...
					case "selector":
						...
						break;
					case "limit":
						data=initPicker.limit(_this.dayStep,_this.startHour,_this.endHour,_this.minuteStep,_this.afterStep);
						break;
					case "range":
